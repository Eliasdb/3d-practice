...
export function SceneContainer() {
  return (
    <Suspense fallback={null}>
      <Environment background={"only"} files={import.meta.env.BASE_URL + "textures/bg.hdr"} />
      <Environment background={false} files={import.meta.env.BASE_URL + "textures/envmap.hdr"} />
